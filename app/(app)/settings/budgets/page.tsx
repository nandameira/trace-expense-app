...
export default async function BudgetSettingsPage() {
  ...
  return (
    <main className="px-6 py-10 lg:px-10">
      ...
      {rows.length === 0 ? (
        <div className="tile flex flex-col items-start gap-4 p-6">
          <img src="/traces-icon.svg" alt="" width={40} height={40} className="rounded-lg" />
          <p className="type-h3">Nothing here yet</p>
          ...
          <Link
            href="/onboarding"
            className="btn-primary mt-2 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink"
          >
            Set up my budget
          </Link>
        </div>
